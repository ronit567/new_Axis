...
export const ReportRepository = {
  ...
  // reports_target_present constraint requires at least one of the two target
  // columns — callers always have one, per ReportTarget. A 'listing' report
  // sends the listing and its seller, so a moderator can act on either without
  // a second lookup.
